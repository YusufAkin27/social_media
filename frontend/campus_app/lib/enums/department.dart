enum Department {
  ...
  ISLAMI_ILIMLER_MTOK("İslami İlimler (MTOK)"),
  ...
  ANTRENORLUK_EGITIMI("Antrenörlük Eğitimi"),
  BEDEN_EGITIMI_VE_SPOR_OGRETMENLIGI("Beden Eğitimi ve Spor Öğretmenliği"),
  SPOR_YONETICILIGI("Spor Yöneticiliği"),
