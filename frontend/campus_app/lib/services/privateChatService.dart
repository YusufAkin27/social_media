...
class PrivateChatService {
  ...
  // Mesaj gönder
  Future<Response> sendPrivateMessage(String token, dynamic sendMessageRequest) async {
    final response = await _dio.post(
      '/privateChat/send',
  ...
  Future<Response> sendPrivateMessageFiles(String token, dynamic sendMessageRequest, List<MultipartFile> files) async {
  ...
  // Mesajı sil
  Future<Response> deleteMessage(String token, dynamic deleteMessageRequest) async {
  ...
  Future<Response> updateMessageStatus(String token, dynamic updateMessageStatusRequest) async {
    final response = await _dio.put(
