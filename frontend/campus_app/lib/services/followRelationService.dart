...
class FollowRelationService {
  ...
  Future<DataResponseMessage<List<FollowedUserDTO>>> getFollowing(String token, int page) async {
    ...
    return DataResponseMessage<List<FollowedUserDTO>>.fromJson(
      response.data,
      (data) => (data as List).map((item) => FollowedUserDTO.fromJson(item as Map<String, dynamic>)).toList(),
    );
  }

  // Kullanıcıyı takip eden kişileri sayfalı şekilde al
  Future<DataResponseMessage<List<FollowedUserDTO>>> getFollowers(String token, int page) async {
    final response = await _dio.get(
  ...
  Future<DataResponseMessage<List<FollowedUserDTO>>> searchFollowers(String token, String query, int page) async {
    final response = await _dio.get(
  ...
  Future<DataResponseMessage<List<FollowedUserDTO>>> searchFollowing(String token, String query, int page) async {
    final response = await _dio.get(
  ...
  Future<DataResponseMessage<List<String>>> getCommonFollowers(String token, String username) async {
    final response = await _dio.get(
  ...
  Future<DataResponseMessage<List<PostDTO>>> getFollowingPosts(String token, String username) async {
    final response = await _dio.get(
  ...
  Future<DataResponseMessage<List<SearchAccountDTO>>> getFollowersByUsername(String token, String username) async {
    final response = await _dio.get(
  ...
  Future<DataResponseMessage<List<SearchAccountDTO>>> getFollowingByUsername(String token, String username) async {
    final response = await _dio.get(
  ...
  Future<DataResponseMessage<List<SearchAccountDTO>>> searchInFollowers(String token, String username, String query) async {
    final response = await _dio.get(
  ...
  Future<DataResponseMessage<List<SearchAccountDTO>>> searchInFollowing(String token, String username, String query) async {
    final response = await _dio.get(
